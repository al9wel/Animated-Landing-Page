            ...
            <motion.section id='home' className='sticky top-0 p-2 h-screen  '>
                <motion.div className='bg-container/98 backdrop-blur-2xl w-full min-h-[97vh] md:min-h-180 rounded-md font-regular overflow-hidden'>
                    ...
                    < motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8, duration: 1, ease: "backOut" }} className='hidden lg:flex relative text-title2 justify-center font-light items-center gap-4 lg:mt-8 xl:mt-4' >
                        <p className='max-w-100 xl:max-w-130 xl:text-[22px] text-black/70 px-2 font-Saira font-light  bg-background2 uppercase'>I’m a creative <span className='bg-info1 text-background2 mt-1 border shadow shadow-black border-black/40 px-1 inline-block'>FRONTEND</span> Developer with a deep love for  design  and clean<span className='bg-info2 text-black/70 mb-1 mx-1 border shadow shadow-black border-black/40 px-1 inline-block'>code.</span></p>
                    ...
                    < motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1, duration: 1, ease: "backOut" }} className='lg:hidden relative flex justify-start items-center flex-col p-4 gap-4 mt-4' >
                        <p className='max-w-[600px] text-background2 uppercase font-Saira leading-7 '>Hi there! I’m a passionate <span className='bg-info1/70 px-1 text-background2'>FrontEnd</span> Developer  who loves <span className='bg-info2/70 px-1  text-background2'> crafting </span> interactive  modern , and visually <span className='bg-info4/70 text-background2 px-2'>appealing</span>  websites</p>
                    ...
                    <motion.div class="relative mt-5 sm:mt-10 h-1 lg:mt-5 xl:mt-2   w-full bg-gradient-to-r from-transparent via-info2 to-transparent">
